...
must survive the `nimino messages send` shell call as real newline bytes. The
...
[asopitech-labs/nimino#5787](https://github.com/asopitech-labs/nimino/issues/5787).

Run with the command in the parent [README](../README.md), replacing the task
path with `benchmarks/nimino-dataset/multiline-message`.
