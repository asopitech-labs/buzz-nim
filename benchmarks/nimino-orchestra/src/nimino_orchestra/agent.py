"""Harbor custom-agent entry point for Nimino orchestration."""
...
from .container_runtime import NiminoContainerRuntime, EndpointLaunchConfig
from .manifest import ExperimentManifest
from .provisioning import TrialProvisioner
from .runtime import OrchestraRuntime


class NiminoOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Nimino trial."""
    ...
    def _build_runtime(
        ...
        nimino_acp_binary: str,
        nimino_agent_binary: str,
        nimino_dev_mcp_binary: str,
        nimino_cli_binary: str,
        relay_gateway: str,
        ...
        return NiminoContainerRuntime(
            ...
            endpoints=endpoints,
            nimino_acp_binary=nimino_acp_binary,
            nimino_agent_binary=nimino_agent_binary,
            nimino_dev_mcp_binary=nimino_dev_mcp_binary,
            nimino_cli_binary=nimino_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "NiminoOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "nimino_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
