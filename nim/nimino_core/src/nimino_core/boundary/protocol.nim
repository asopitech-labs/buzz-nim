...
when defined(niminoBoundaryWrongSchema):
  ...
  const BoundarySchemaHash* = "bed77a5197d97b36ce1a8c46e3877d5dbcbc4e493cd5fd730250aa698bafd0a8"
...
proc decodeOperation(
  ...
  of "domain.membership.policy":
    ...
    result.data = payload
  of "domain.dm.policy":
    result.kind = boDmPolicy
    result.data = payload
  of "domain.moderation.policy":
    result.kind = boModerationPolicy
    result.data = payload
  ...
  of "domain.cli.policy":
    ...
    result.data = payload
  of "domain.agent.policy":
    result.kind = boAgentPolicy
    result.data = payload
  of "domain.cluster.lifecycle":
    result.kind = boClusterLifecycle
    result.data = payload
  of "domain.admission.policy":
    result.kind = boAdmissionPolicy
    result.data = payload
  of "domain.ephemeral.policy":
    result.kind = boEphemeralPolicy
    result.data = payload
