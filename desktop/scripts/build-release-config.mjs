...
//    Both NIMINO_UPDATER_PUBLIC_KEY and NIMINO_UPDATER_ENDPOINT are required -
...
const updaterPubkey = process.env.NIMINO_UPDATER_PUBLIC_KEY;
const updaterEndpoint = process.env.NIMINO_UPDATER_ENDPOINT;

const missing = [];
if (!updaterPubkey) missing.push("NIMINO_UPDATER_PUBLIC_KEY");
if (!updaterEndpoint) missing.push("NIMINO_UPDATER_ENDPOINT");
if (missing.length > 0) {
  console.error(
