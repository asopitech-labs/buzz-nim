...
export default {
  theme: {
    extend: {
      ...
      // (`--nimino-type-rem` in styles/globals/typography.css), which is
      ...
      fontSize: {
        "2xs": "calc(var(--nimino-type-rem) * 0.6875)", // 11px at 16px type rem
        "3xs": "calc(var(--nimino-type-rem) * 0.5)", // 8px at 16px type rem
        badge: "calc(var(--nimino-type-rem) * 0.625)", // 10px at 16px type rem
        ...
        title: [
          "calc(var(--nimino-type-rem) * 2.5)",
          { lineHeight: "1.15", letterSpacing: "-0.02em" },
        ],
        // 36px at the 16px type rem — backup-step private key.
        "nsec-key": [
          "calc(var(--nimino-type-rem) * 2.25)",
          { lineHeight: "1.3" },
        ],
      },
      lineHeight: {
