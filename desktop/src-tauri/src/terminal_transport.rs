...
use nimino_terminal::{damage::Frame, Viewport};
use std::fmt;
...
impl FramePublisher {
    ...
    /// teardown, or explicit detach. The caller owns safe Nimino focus recovery.
...
mod tests {
    use super::*;
    use nimino_terminal::damage::{CursorFrame, RowFrame};
