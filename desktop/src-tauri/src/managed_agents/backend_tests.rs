...
fn provider_filename_strips_the_windows_extension() {
    assert_eq!(
        provider_id_from_filename("nimino-backend-kubernetes"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("nimino-backend-kubernetes.exe"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("nimino-backend-kubernetes.EXE"),
    ...
    assert_eq!(
        provider_id_from_filename("nimino-backend-kubernetes.bat"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("nimino-backend-kubernetes.CMD"),
        Some("kubernetes")
    );
    assert_eq!(
        provider_id_from_filename("nimino-backend-my-provider"),
        Some("my-provider")
    );
