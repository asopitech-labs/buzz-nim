...
const CONVERSATION_SCROLL_SELECTOR = "[data-nimino-conversation-scroll]";
 ...
 *
 * Nimino is laid out as fixed-height nested panes. On macOS, a wheel/trackpad
 ...
 * boundaries, only containers marked with `data-nimino-conversation-scroll` are
