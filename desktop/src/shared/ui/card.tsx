...
export const TEXTURED_SURFACE_CLASS =
  "nimino-card-textured relative isolate rounded-none border-0 bg-transparent p-[var(--nimino-card-textured-safe-inset)] shadow-none";
...
export function texturedSurfaceClasses({
  ...
  return cn(
    ...
    tone === "dark" && "nimino-card-textured-dark",
    size === "compact" && "nimino-card-textured-compact",
  );
}
 ...
 * - Default padding is the safe inset (`--nimino-card-textured-safe-inset`),
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === "textured" &&
            textureTone === "dark" &&
            "nimino-card-textured-dark",
          variant === "textured" &&
            textureSize === "compact" &&
            "nimino-card-textured-compact",
        )}
        {...props}
      />
    );
