...
export function SpoilerInline({
  ...
  if (!interactive) {
    if (isBlock) {
      return (
        <div
          className="nimino-spoiler nimino-spoiler--block nimino-spoiler--inert"
          data-revealed="false"
          data-spoiler=""
        >
          <SpoilerParticles active contentRef={contentRef} />
          <div className="nimino-spoiler__content" ref={setContentElement}>
    ...
    return (
      <span
        className="nimino-spoiler nimino-spoiler--inert"
        data-revealed="false"
        data-spoiler=""
      >
        <SpoilerParticles active contentRef={contentRef} />
        <span className="nimino-spoiler__content" ref={setContentElement}>
          <SpoilerHiddenContext.Provider value={true}>
            {children}
          </SpoilerHiddenContext.Provider>
        </span>
  ...
  if (isBlock) {
    return (
      <div
        {...revealProps}
        className="nimino-spoiler nimino-spoiler--block"
