...
const TIMECODE_ACCENT_CLASS =
  "bg-[hsl(var(--nimino-video-review-accent,var(--primary))/0.15)] text-[hsl(var(--nimino-video-review-accent-foreground,var(--nimino-video-review-accent,var(--primary))))]";
const TIMECODE_ACCENT_HOVER_CLASS =
  "hover:bg-[hsl(var(--nimino-video-review-accent,var(--primary))/0.3)]";
