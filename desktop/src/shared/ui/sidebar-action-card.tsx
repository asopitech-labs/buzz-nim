...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="nimino-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="nimino-sidebar-action-description">
      ...
      <span aria-hidden className="nimino-sidebar-action-description__motion">
        <span
          className="nimino-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "nimino-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
