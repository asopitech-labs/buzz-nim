...
test("nimino-acp wrapped auth failure → denied copy", () => {
...
test("unwrapped nimino-agent prefix → denied copy", () => {
  // nimino-agent's AgentError::LlmAuth Display is "llm auth: <body>"; if the
...
test("code -32001 → Nimino shared compute denied copy (structured path)", () => {
