 ...
 * mirroring the Rust interpreter in `crates/nimino-agent/src/model_capabilities.rs`
...
/** Valid thinking-effort values accepted by nimino-agent (mirrors parse_thinking_effort in config.rs). */
