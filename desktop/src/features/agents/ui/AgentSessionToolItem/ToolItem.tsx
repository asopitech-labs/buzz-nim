...
import { getNiminoToolInfo } from "../agentSessionToolCatalog";
...
export function ToolItem({
  ...
  const canonicalToolName = item.niminoToolName ?? item.toolName;
  const niminoTool = getNiminoToolInfo(canonicalToolName);
