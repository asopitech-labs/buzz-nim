      ...
      >
        ...
        {activeTab === "emoji" ? (
          <div className="relative grid content-start gap-3">
            <div
              className="nimino-emoji-mart relative z-0 h-[280px] overflow-hidden rounded-lg bg-muted"
                    ...
                    >
                      <span
                        className={cn(
                          "flex h-full w-full items-center justify-center leading-none",
                          isCompact ? "text-2xl" : "text-[4rem]",
                          squishKey > 0 && "nimino-avatar-squish",
                        )}
                        key={squishKey}
                        style={
                          {
                            "--nimino-avatar-emoji-offset-x": "0px",
                            "--nimino-avatar-emoji-offset-y": "0px",
