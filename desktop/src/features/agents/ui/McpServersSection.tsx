...
type McpServersSectionProps = {
  ...
  niminoAgentSlot?: React.ReactNode;
};
...
export function McpServersSection({
  ...
  const isNiminoAgent = runtimeId === "nimino-agent";
  ...
  return (
    ...
    >
      ...
      {isNiminoAgent && niminoAgentSlot ? niminoAgentSlot : null}
