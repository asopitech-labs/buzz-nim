 ...
 * light-blue label (`--nimino-onboarding-cta-label`, available on any
 * `.nimino-onboarding-neutral-theme` subtree).
 */
export const ONBOARDING_PRIMARY_CTA_CLASS = `${ONBOARDING_CTA_SHAPE} text-[var(--nimino-onboarding-cta-label)]`;
 ...
 * chartreuse label (`--nimino-welcome-chartreuse`). The blue label is reserved
 * for the CTAs inside the steps.
 */
export const ONBOARDING_LANDING_CTA_CLASS = `${ONBOARDING_CTA_SHAPE} text-[var(--nimino-welcome-chartreuse)]`;
 ...
 * olive backup ink (`--nimino-onboarding-backup-ink`) with a plain
...
export const ONBOARDING_INK_ICON_CLASS =
  "text-[color:var(--nimino-onboarding-backup-ink)] hover:bg-transparent hover:text-foreground";
 ...
 * static Nimino mark pinned to the top-left, and a centered pagination track that
