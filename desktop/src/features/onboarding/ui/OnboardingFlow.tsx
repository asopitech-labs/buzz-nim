...
export function OnboardingFlow({
  ...
  return (
    <>
      <div
        className="nimino-onboarding-neutral-theme nimino-startup-shell flex items-start justify-center overflow-y-auto bg-background px-4 pb-28 pt-[106px] text-foreground"
                  ...
                  {identityLost ? (
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Re-import your nsec to restore it — Nimino will restart
                    ...
                    <>
                      ...
                      <p className="mt-5 text-sm leading-6 text-muted-foreground">
                        ...
                        Nimino. If this key already has a profile on the relay,
