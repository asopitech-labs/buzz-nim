...
const STORAGE_KEY = "nimino-community-onboarding-transaction.v1";
...
export function markCommunityOnboardingComplete(
  ...
  storage.setItem(
    `nimino-community-onboarding-complete.v1:${encodeURIComponent(relayUrl)}:${pubkey}`,
    "true",
  );
  ...
  storage.setItem(`nimino-onboarding-complete.v1:${pubkey}`, "true");
}
