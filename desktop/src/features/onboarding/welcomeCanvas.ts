...
export const WELCOME_CANVAS_CONTENT = `# Welcome to Nimino
...
Ask the team a question here, or read the [Nimino user guide](https://github.com/asopitech-labs/nimino#readme).
`;
