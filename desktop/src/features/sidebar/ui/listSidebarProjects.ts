...
const SIDEBAR_PROJECTS_FILTER_KEY = "nimino.sidebar.projects.filter";
const SIDEBAR_PROJECTS_SORT_KEY = "nimino.sidebar.projects.sort";
const SIDEBAR_PROJECTS_EXPANDED_KEY = "nimino.sidebar.projects.expanded";
