...
const participationStore = makeRootIdStore("nimino-thread-participation.v1");
const authoredStore = makeRootIdStore("nimino-thread-authored.v1");
const mutedRootsStore = makeRootIdStore("nimino-thread-muted.v1");
const FOLLOWS_STORAGE_KEY_PREFIX = "nimino-thread-follows.v1";
