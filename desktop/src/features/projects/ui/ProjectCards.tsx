...
function RepositoryUnavailableIndicator({
  ...
  const status = {
    authentication: {
      description: "Nimino could not authenticate with this repository.",
      label: "Access failed",
    },
    missing: {
      description: "No git repository was found on the Nimino relay.",
      label: "Uninitialized",
    },
    access: {
      description:
    ...
    network: {
      description: "The Nimino git service could not be reached.",
      label: "Unreachable",
    },
    ref: {
    ...
    unknown: {
      description: "Nimino could not load this repository.",
      label: "Unavailable",
    },
  } satisfies Record<
