...
const SPOILER_SELECTOR = ".nimino-spoiler[data-spoiler]";
...
function mountComposerSpoilerParticles(
  ...
  overlayRoot.className = "nimino-spoiler-composer-particles";
  ...
  const mountSpoiler = (spoiler: HTMLElement) => {
    ...
    canvas.className =
      "nimino-spoiler__particles nimino-spoiler__particles--composer";
