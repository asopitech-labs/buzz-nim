...
const SPOILER_MARKDOWN_RULE = "nimino_spoiler";
const SPOILER_OPEN_TOKEN = "nimino_spoiler_open";
const SPOILER_CLOSE_TOKEN = "nimino_spoiler_close";
...
export function registerSpoilerMarkdownIt(
  ...
  md.renderer.rules[SPOILER_OPEN_TOKEN] = () =>
    '<span data-spoiler="" class="nimino-spoiler">';
