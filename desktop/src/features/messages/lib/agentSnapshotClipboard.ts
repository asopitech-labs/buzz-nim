...
const CLIPBOARD_ATTRIBUTE = "data-nimino-agent-snapshot";
...
/** Build Nimino-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a Nimino snapshot clipboard payload into one pending attachment. */
