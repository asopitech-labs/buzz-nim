...
export function AvatarFramingSlider({
  ...
  const sliderControl = (
    <div className="nimino-avatar-framing-slider-wrapper">
      <div
        ...
        className={cn(
          "nimino-avatar-framing-slider",
          compact && "nimino-avatar-framing-slider--compact",
        )}
        ...
        style={
          {
            "--nimino-avatar-framing-slider-fill": `${fill}%`,
          } as React.CSSProperties
        }
        tabIndex={disabled ? -1 : 0}
      >
        <div className="nimino-avatar-framing-slider-hashmarks">
          {ticks.map((tick) => (
            <span
              aria-hidden="true"
              className="nimino-avatar-framing-slider-hashmark"
              key={tick}
              style={{
        ...
        <div aria-hidden="true" className="nimino-avatar-framing-slider-fill" />
        <div
          aria-hidden="true"
          className="nimino-avatar-framing-slider-handle"
        />
      </div>
      <button
      ...
      {tipText ? (
        <p
          className="nimino-avatar-framing-slider-tip"
