...
export type InboxItem = {
   ...
   * repository-scoped root for Nimino Git work. Does NOT change when a new reply
...
/**
 * Returns the stable conversation ID for any FeedItem or relay event. Nimino Git
