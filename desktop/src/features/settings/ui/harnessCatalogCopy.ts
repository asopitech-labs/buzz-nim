 ...
 * here. Research: ~/.nimino/RESEARCH/BYOH_CATALOG_IA.md.
 */

const HARNESS_DESCRIPTIONS: Record<string, string> = {
  // Built-in runtimes.
  "nimino-agent": "Nimino's built-in agent runtime, bundled with the app.",
  ...
  cursor: "Cursor's coding agent, connected to Nimino through its ACP server.",
  ...
  grok: "xAI's coding agent, connected to Nimino through its ACP entrypoint.",
