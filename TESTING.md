...
export NIMINO_RELAY_PRIVATE_KEY="<same key used by buzz-relay>"
...
#    buzz-acp wants ws:// (not http://). If you set NIMINO_RELAY_URL to an
...
> code / buzz-agent, set `NIMINO_ACP_AGENT_COMMAND` and `NIMINO_ACP_AGENT_ARGS`
