...
# Installed Nimino state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Nimino app state and its production keyring are preserved."
  echo ""
...
success "Desktop development state removed (installed Nimino state preserved)"
