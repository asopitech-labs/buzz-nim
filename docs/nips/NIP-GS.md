...
2. `NIMINO_PRIVATE_KEY` environment variable.
...
1. `NIMINO_AUTH_TAG` environment variable — a JSON-encoded array of 4 strings
...
(`NOSTR_PRIVATE_KEY`, `NIMINO_PRIVATE_KEY`). Environment variables are visible
to:
