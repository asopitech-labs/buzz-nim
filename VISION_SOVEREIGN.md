# Nimino — Your Project, Your Domain
...
Next to it, a "Connect on Nimino" button.
...
You hit "Connect on Nimino" and the app opens. You're in `#general`. The team is
...
"Connect on Nimino" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Nimino as a collaboration
layer on top of GitHub if that's what makes sense — work in Nimino channels, push
...
Someone picks up the bug. They create a branch. Nimino creates a channel:
...
things are announcements. Some things are essays. Nimino has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Nimino"
