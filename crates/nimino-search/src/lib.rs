#![deny(unsafe_code)]
#![warn(missing_docs)]
//! Nimino search — community-scoped Postgres full-text search over Nimino events.
//!
...
//! by `nimino-db`. The relay refetches canonical events through `nimino-db`'s
...
pub use nimino_core::CommunityId;
