...
```bash
tamarin-prover --prove crates/nimino-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `nimino-pair test-vectors`.
