...
pub const FORMAT: &str = "nimino-private-managed-agent";
...
mod tests {
    ...
    fn projection_hash_fixture_is_stable() {
        assert_eq!(
            content_sha256(b"nimino-private-managed-agent-v1"),
            "4f74f6bf74539f1025199360d7066f777e96b2b4c89f045616785dedd5c8a3eb"
        );
    }
}
