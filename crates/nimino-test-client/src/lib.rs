...
//! Minimal NIP-01 WebSocket test client for the Nimino relay.
...
use nimino_ws_client::NostrWsConnection;
pub use nimino_ws_client::{parse_relay_message, OkResponse, RelayMessage, WsClientError};

/// Errors returned by [`NiminoTestClient`] operations.
#[derive(Debug, Error)]
...
/// WebSocket test client for integration testing against a running Nimino relay.
pub struct NiminoTestClient {
    inner: NostrWsConnection,
}

impl NiminoTestClient {
