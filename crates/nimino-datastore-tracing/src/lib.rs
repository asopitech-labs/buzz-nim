...
/// Instruments an async logical datastore operation according to Nimino policy.
///
/// PostgreSQL spans always omit function arguments, use the `nimino_datastore`
...
pub fn datastore_span(args: TokenStream, item: TokenStream) -> TokenStream {
    ...
    let result = format_ident!("__nimino_datastore_result_7f3a9c");
