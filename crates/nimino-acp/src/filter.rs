...
///   `str_ends_with`, `str_len` (duplicated intentionally from nimino-workflow).
...
/// `str_len` — duplicated from nimino-workflow intentionally so this crate
/// has no runtime dependency on nimino-workflow.
