//! Immutable capabilities for Nimino Desktop's April Pocket TTS bundle.
...
/// Capabilities of Nimino Desktop's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for Nimino Desktop's April INT8 model.
