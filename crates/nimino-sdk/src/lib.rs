#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `nimino-sdk` — typed Nostr event builders for Nimino operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need nimino-core directly.
pub use nimino_core::kind;
...
pub use nimino_core::channel::canonical_channel_name;
/// Channel type.
pub use nimino_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use nimino_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use nimino_core::channel::MemberRole;
