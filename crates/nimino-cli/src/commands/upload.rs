...
pub async fn dispatch(cmd: crate::UploadCmd, client: &NiminoClient) -> Result<(), CliError> {
    match cmd {
...
pub async fn dispatch_media(cmd: crate::MediaCmd, client: &NiminoClient) -> Result<(), CliError> {
    match cmd {
