...
pub fn sdk_err(e: nimino_sdk::SdkError) -> CliError {
    match e {
        nimino_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `nimino_sdk::mentions` and are tested there.
